...
djCDtime:int = getattr(config, "djcdtime", 12000)     # 打胶冷却时间
pkCDTime:int = getattr(config, "pkcdtime", 60)     # pk冷却时间
suoCDTime: int = getattr(config, "suocdtime", 12000)     # 嗦牛子冷却时间
fuckCDTime: int = getattr(config, "fuckcdtime", 3600)     # 透群友冷却时间
ImpartBlacklist: list = getattr(config,"ImpartBlacklist",[])